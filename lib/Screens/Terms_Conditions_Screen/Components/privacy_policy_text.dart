class PrivacyPolicyText<String> {
  String? title;
  dynamic data;

  PrivacyPolicyText({this.title, this.data});

  static List<PrivacyPolicyText> privacyData() {
    return [
      PrivacyPolicyText(
          title: "Privacy Policy",
          data:
              """MegaVideo is a video chat mobile application. You can meet cool and interesting people from all over the world, enjoy fun chats, and make new friends on our platform.

This Privacy Policy covers what SnopCat Developer (“MegaVideo” “MegaVideo App” “we” “our” ) does with the Personal Information (as defined herein) that you share with us and the data we collect when you are accessing our App and/or our Service. Personal Information about our users is an integral part of our business, so please read this Privacy Policy carefully. By using or accessing our App or our Service, you agree to the privacy policies outlined below."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
          title: "What Does this Privacy Policy Cover?",
          data:
              """This Privacy Policy covers MegaVideo's treatment of Personal Information that we collect while you are using the App and the Service. This policy does not apply to the practices of third parties that MegaVideo does not own or control, including but not limited to third party services you access through MegaVideo, the App or the Service, or to individuals that MegaVideo does not employ or manage. As our Service integrates with third party sites, and other sites and social networks, we assume that you are already aware of the privacy policies of those other sites and networks when using our App and/or our Service and when you allow us to interact with these sites and networks on your behalf."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
          title: "The Service",
          data:
              """The key functionality of MegaVideo is a video chat mobile application where users can meet cool and interesting people from all over the world, enjoy fun chats, and make new friends on our platform. It pairs individuals (“Users”) together based on compatibility and other factors, and to enable individuals to chat and communicate online through various media including text, and video (collectively, the “Service”).

According to relevant international regulation, MegaVideo will not provide the Service in the following countries or territories:
...
Crimea"""
      ...
      PrivacyPolicyText(
          ...
          data: """There are three basic ways we collect information:
...
Here’s a little more detail on each of these categories."""
      ...
      PrivacyPolicyText(
          ...
          data:
              """By visiting and interacting with MegaVideo, its App and/or its Service, you provide us with Personal Information which may include, but is not limited to, the following:

  - Personally Identifiable Information: may include, without limitation, information provided when you register to use the App and/or the Service, including your name, profile picture, date of birth, phone number, phone book content, address, email address, occupation, employer, gender, age, birthday, and friend list, and/or other social network usernames and ‘likes' and preferences, friend lists and number of friends you have via social networks, messages to other users of the App and the Service, use information regarding your use of the Service, profile picture that you upload via the App or the Service, and browser information.

  - The information you choose to provide above may be shared with your contacts on our service. You have total control over your profile information and you can modify at any time. Your Profile is available to other users of the Service who are connected to you on our service. In addition, unless you opt-out (which you may do so at any time in the settings of our application), your Profile is discoverable by other users. You may choose to “block” any user on our platform to prevent unwanted access of your Personal Information.

  - You may also choose to share your mobile device’s Contacts list with us (including names, numbers, emails, Apple ID, etc) and we will store it on our servers to help you better improve our service, e.g. connecting with friends on our service. If you do not want us to store this information, you may opt-out through your account settings or notify us via email. If done so, we will not be able to offer some of our features on our service.

Of course, you’ll also provide us whatever information you send through the services. Keep in mind that the users you send texts, images, and any other content to can always save that content or copy it outside the app. So, the same common sense that applies to the Internet at large applies to MegaVideo as well: Don’t send messages or share content that you wouldn’t want someone to save or share.

It probably goes without saying, but we’ll say it anyway: When you contact MegaVideo Support or communicate with us in any other way, we’ll collect whatever information you volunteer."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
          title: "Information We Get When You Use Our Services",
          data:
              """When you use our services, we collect information about which of those services you’ve used and how you’ve used them. We might know, for instance, how many people you’ve had a video chat conversation with and for how long. Here’s a fuller explanation of the types of information we collect when you use our services:
...
Usage Information. We collect information about your activity through our services. We may collect information including but not limited to:
  ...
  - User content e.g. photos, screenshots, comments, and other materials that you create on the service may also be collected. Your photos and videos may be captured by other users on the service, and those content can be stored and used by us or third party services for content moderation and community safety monitoring purposes. You can change third party sharing options in our product settings or writing to us directly.

  - Device Phonebook. Because MegaVideo is all about communicating with friends, we may—with your consent—collect information from your device’s phonebook.
  ...
  - If you contact us by email and other means we may keep a record of your contact information and correspondence and will use these contact info and correspondence if we respond to you."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
...
We may also store some information locally on your device. For example, we may store information as local cache so that you can open the app and view content faster."""
  ...
  - With our affiliates, we may share information with entities within the MegaVideo family of companies.
  ...
  - With third parties as part of a merger or acquisition. If MegaVideo gets involved in a merger, asset sale, financing, liquidation or bankruptcy, or acquisition of all or some portion of our business to another company, we may share your information with that company before and after the transaction closes.
...
If you do not agree with all of the terms of this Privacy Policy, please do not use our service. Community safety is our number one priority and some of the above user information are mandatory in order to create a safe community for all users."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
          title: "Information You Choose to Share with Third Parties",
          data:
              """The services may also contain third-party links and search results, include third-party integrations, or be a co-branded or third-party-branded service that’s being provided jointly with or by another company. By going to those links, using the third-party integration, or using a co-branded or third-party-branded service, you may be providing information (including personal information) directly to the third party, us, or both. You acknowledge and agree that we are not responsible for how those third parties collect or use your information. To the extent that you use a profile that may be available to others on our Service, you are solely responsible for its content and accuracy at all times. As always, we encourage you to review the privacy policies of every third-party website or service that you visit or use, including those third parties you interact with through our services."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
          title: "Promotional Emails and Messages",
          data:
              """You may choose to receive the newsletters, surveys, discounts, and other promotional materials from us through emails and messages. We will also send the latest information on products and services, and other offers with your consent. You can stop receiving promotional emails by unsubscribing from emails and messages any time. If you unsubscribe from receiving such promotional emails, we may still deliver you service-related communications and in-app messages."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
...
Due to the inherent nature of the internet and related technology, we do not guarantee the protection of information under our control against loss, misuse, or alteration."""
  ...
  - Access and Updates. We strive to let you access and control the personal information that we have about you. There are limits though to the requests we’ll accommodate. We may reject a request for a number of reasons, including, for example, that the request risks the privacy of other users or is unlawful. You can access and update your account information right in the app by visiting the app’s Settings page. If you need to access, update, or delete any other personal information that we may have, you can send an email request to subuxess@gmail.com. Because your privacy is important to us, we may ask you to verify your identity or provide additional information before we let you access or update your personal information. You can also remove our service from your mobile device or process account deletion.
  ...
  - Erasure. You have the right to ask for your personal information to be deleted in certain circumstances. Please note that your right to erasure may be limited if the data are necessary for compliance with a legal obligation or for the establishment, exercise or defence of legal claims.
  ...
  - Objection: You have the right to object, on grounds relating to your particular situation, at any time to processing of your personal information.  

MegaVideo shall no longer process the personal information unless MegaVideo demonstrates compelling legitimate grounds for the processing which override your interests, rights and freedoms or for the establishment, exercise or defence of legal claims;
...
If you wish to update or delete your personal information submitted, you can update it via the App. Alternatively, you can send your email request to subuxess@gmail.com."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
          title: "Retention of Your Data",
          data:
              """We will keep your personal data only for so long as is necessary to fulfill the purposes outlined in this Privacy Policy, unless the law requires us to keep it for a longer period. Once we no longer need your personal data, we will either irreversibly anonymise or securely delete it from our servers."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
          title: "Underage Users",
          data:
              """Our services are not intended for—and we don’t direct them to—anyone under 18. Anyone under 18 is not allowed to use our Services. Therefore we do not collect the user information of anyone under the age of 18. In the event that the information you provide in this regard is not truthful, MegaVideo shall not be liable as it cannot verify the age of its users. If you are under 18 years old, do not attempt to register or use the App or the Service. If you are under the age of 18, you may NOT use the Service, with or without the approval of a parent or guardian."""
                  .replaceAll("   ", " ")),
      PrivacyPolicyText(
